const BOOKS = {
  selva_acuarela: {
    ...
    pages: [
      ...
      { num: 3, scene: 'la_selva_aparece', seed: 77003, text: 'Al ponerse la mochila, zas! Su habitacion desaparecio y [NOMBRE] se encontro en medio de una selva enorme y colorida.', promptScene: 'child [CHILD_DESC] wearing green backpack, surrounded by magical swirling transformation, bedroom dissolving into lush jungle, giant tropical leaves, fireflies, magical sparkles, sense of wonder and excitement' },
      ...
      { num: 5, scene: 'mia_monita', seed: 77005, text: 'Mas adelante, Mia la monita estaba atrapada en una rama muy alta.', promptScene: 'child [CHILD_DESC] standing below a tall jungle tree, holding a rope, helping a small scared monkey safely descend from a high branch, dappled sunlight through jungle canopy, friendly determined expression' },
